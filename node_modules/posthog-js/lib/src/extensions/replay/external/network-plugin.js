    ...
    var restorePatch = (0, patch_1.patch)(win, 'fetch', function (originalFetch) {
        return function (url, init) {
            return __awaiter(this, void 0, void 0, function () {
                var req, res, networkRequest, start, end, requestHeaders_1, requestBodyIsReadableStream, _a, _b, responseHeaders_1, _c;
                return __generator(this, function (_d) {
                    switch (_d.label) {
                        case 0:
                        ...
                        case 3:
                            start = win.performance.now();
                            if (!isRequest(url)) return [3 /*break*/, 5];
                            return [4 /*yield*/, originalFetch(req)];
                        case 4:
                            _b = _d.sent();
                            return [3 /*break*/, 7];
                        case 5: return [4 /*yield*/, originalFetch(url, init)];
                        case 6:
                            _b = _d.sent();
                            _d.label = 7;
                        case 7:
